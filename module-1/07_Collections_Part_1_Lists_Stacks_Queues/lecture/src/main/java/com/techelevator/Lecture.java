...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		//and walk through the end one by one
		...
		// we declare the name of the variable
		...
		// if we want to remove all of them, we can use .contains
		...
		System.out.print("Is Hulk an avenger? " + names.contains("Hulk"));
