...
-- Add Hawkins, IN (with a population of 30,000 and an area of 38.1 square kilometers) and Cicely, AK
-- (with a popuation of 839 and an area of 11.4 square kilometers) to the city table.
...
INSERT INTO park(park_name, date_established, area, has_camping)
VALUES ('Bearland', '7/17/1955', 2.1, false) RETURNING park_id;
