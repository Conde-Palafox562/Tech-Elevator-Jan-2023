...
-- WHERE area BETWEEN 100 AND 200; <- This will pull the exact same results as line 121. This is just another
-- way of executing that code
...
SELECT *
FROM park
WHERE date_established < '1/1/1980';
-- We can also write it in YYYY/MM/DD format: 1900/1/1
